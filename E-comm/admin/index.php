...
<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
  <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6" href="index.php">Collins's Market</a>
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3 sidebar-sticky">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?brands">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?category">
              <span data-feather="layers" class="align-text-bottom"></span>
              All Categories
            </a>
          </li>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom"><?php
        if(isset($_GET['category'])){
            echo "<h1 class=\"h2\">All Categories</h1>";
        }
        else if(isset($_GET['insert_categories'])){
          echo "<h1 class=\"h2\">Insert Categories</h1>";
        }
        else if(isset($_GET['brands'])){
          echo "<h1 class=\"h2\">Brands</h1>";
        }
        else if(isset($_GET['insert_brands'])){
          echo "<h1 class=\"h2\">Insert Brands</h1>";
        }
        else if(isset($_GET['insert_products'])){
          echo "<h1 class=\"h2\">Add Product</h1>";
        }
        else {
